---
title: "`monoClust` Package Vignette"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{`monoClust` Package Vignette}
...
```{r hyptestv, fig.height=5, fig.cap="Binary partitioning tree with five splits, six clusters, but one split should be pruned based on its p-value of 0.8."}
